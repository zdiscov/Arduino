...
const int tonePin = 2;  // arbitrary for arduino boards, set this to whatever you want
...
//char *song1 = "LeisureSuit:d=16,o=6,b=56:f.5,f#.5,g.5,g#5,32a#5,f5,g#.5,a#.5,32f5,g#5,32a#5,g#5,8c#.,a#5,32c#,a5,a#.5,c#.,32a5,a#5,32c#,d#,8e,c#.,f.,f.,f.,f.,f,32e,d#,8d,a#.5,e,32f,e,32f,c#,d#.,c#";
//char *song = "MissionImp:d=16,o=6,b=95:32d,32d#,32d,32d#,32d,32d#,32d,32d#,32d,32d,32d#,32e,32f,32f#,32g,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,a#,g,2d,32p,a#,g,2c#,32p,a#,g,2c,a#5,8c,2p,32p,a#5,g5,2f#,32p,a#5,g5,2f,32p,a#5,g5,2e,d#,8d";
//char *song = "BachAir:d=4,o=6,b=40:1a5,8p,16d,16a_5,16g5,16f5,16e5,16f5,e.5,8p,2c,16a5,16a5,16d_5,16d5,16g5,16f_5,16c,16a_5,8a_5,16g5,16f5,16g5,16a5,16a_5,16g5,16c5,16g5,16d5,16c5,16f5,16e5,16a_5,16a5,a.5,16b5,16c,8f5,16g5,16a5,16a5,16g5,16g5,16f5,16e5,16d5,8e5,16f5,8f5,16e5,16d5,2c5";
void setup(void)
{
  Serial.begin(9600);
}
...
void loop(void)
{
  play_rtttl(song);
  Serial.println("Done.");
  *song = "EnriqueIg:d=4,o=6,b=125:b5,b.,a.,8g_,8a,2f_,p,8f_,8e,8f_,g_,2g_.,2p,b5,b.,a.,8g_,8a,2f_,p,8f_,8f_,8f_,8g_,8p,g_.,8f_,8e,8f_,g_,g_.";

  play_rtttl(song);
  *song1 = "Jeopardy:d=4,o=6,b=125:c,f,c,f5,c,f,2c,c,f,c,f,a.,8g,8f,8e,8d,8c#,c,f,c,f5,c,f,2c,f.,8d,c,a#5,a5,g5,f5,p,d#,g#,d#,g#5,d#,g#,2d#,d#,g#,d#,g#,c.7,8a#,8g#,8g,8f,8e,d#,g#,d#,g#5,d#,g#,2d#,g#.,8f,d#,c#,c,p,a#5,p,g#.5,d#,g#";
  play_rtttl(song1);
